package com.airschool.apiairschool.resources.exceptions;

import com.airschool.apiairschool.services.exceptions.ObjectDuplicateException;
import com.airschool.apiairschool.services.exceptions.ObjectNotFoundException;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> objectDuplicate(ObjectDuplicateException e, HttpServletRequest request) {
        ...
        StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.CONFLICT.value(), "Duplicate", e.getMessage(), request.getRequestURI());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(err);
    }
